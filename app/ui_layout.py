...
class SRUQueryApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("DNB SRU Query Tool")
        ...
        heading = QLabel("DNB SRU Query Tool")
        ...
        self.intro_label = QLabel("Mit diesem Tool können Sie die SRU-Schnittstelle der Deutschen Nationalbibliothek "
                             "abfragen und die Ergebnisse als Metadatenset herunterladen. <br> Allgemeine Informationen "
